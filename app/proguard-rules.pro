...
#the line including IInAppBillingService is especially important if your
#application offers in-app purchases. Again, some of these exclusionary rules
#could probably be removed, but we’re erring on the side of safety.
